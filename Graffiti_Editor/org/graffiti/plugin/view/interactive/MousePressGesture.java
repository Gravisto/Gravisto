...
/**
 * User gesture that represents pressing a mouse button. It is provided for
 ...
 * @see UserGesture
 */
public class MousePressGesture extends MouseButtonGesture {
    /**
     * Constructs a {@code MousePressGesture}.
     * 
     * @param position
     ...
     *            InputEvent}.
     * @param buttonId
     *            the id of the button that was pressed, as used by
     *            {@link MouseEvent#getButton()}.
     */
    public MousePressGesture(Point2D position, int modifierMask, int buttonId) {
     ...
     *            InputEvent}.
     * @param button
     *            the button that was pressed, as used by
     *            {@link MouseEvent#getButton()}.
     */
    public MousePressGesture(Point2D position, int modifierMask,
            MouseButton button) {
