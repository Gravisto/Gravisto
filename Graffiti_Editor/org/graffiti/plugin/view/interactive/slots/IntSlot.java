...
/**
 * Slot of type {@code Integer}, which can store its value in a preferences
 * tree.
 * 
 * @author Andreas Glei&szlig;ner
 * @version $Revision$ $Date$
 */
public class IntSlot extends Slot<Integer> {
    /**
     ...
     *            the default value.
     */
    public IntSlot(String id, String name, String description, int defaultValue) {
        super(id, name, Integer.class, description);
