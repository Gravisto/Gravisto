 ...
 */
public class SelectReachableSubgraphAction extends SelectionAction {
    /**
     * 
     */
    private static final long serialVersionUID = -25727912465012657L;

    /**
     * Constructs a new copy action.
     * 
     */
    public SelectReachableSubgraphAction() {
        super(GraphEditingBundle
                .getString("menu.selectReachableSubgraphAction"),
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        mainFrame.getActiveEditorSession().getSelectionModel()
                .setActiveSelection(
                        CoreGraphEditing.selectReachableSubgraph(nodes.get(0)));
    }
