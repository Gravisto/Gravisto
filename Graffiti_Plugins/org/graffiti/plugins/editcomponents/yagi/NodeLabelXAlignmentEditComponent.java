 ...
 */
public class NodeLabelXAlignmentEditComponent extends ComboBoxEditComponent
     ...
     */
    public NodeLabelXAlignmentEditComponent(Displayable<?> disp) {
        super(disp);
        // the values for the combobox "alignment"
        this.comboText = new String[] { "use relative X offset", LEFT_OUTSIDE,
                LEFT_INSIDE, CENTERED, RIGHT_INSIDE, RIGHT_OUTSIDE };

        this.comboValue = new String[] { "use relative X offset", LEFT_OUTSIDE,
                LEFT_INSIDE, CENTERED, RIGHT_INSIDE, RIGHT_OUTSIDE };
