// =============================================================================
//
//   EdgeLabelPositionAttributeHandler.java
//
 ...
 */
public class EdgeLabelPositionAttributeHandler extends
        AncestorAttributeHandler<EdgeLabelAttribute> {
    public EdgeLabelPositionAttributeHandler() {
        super(2, RELATIVE_ALIGNMENT, ABSOLUTE_X_OFFSET, ABSOLUTE_Y_OFFSET,
                ALIGNMENT_SEGMENT);
    }
