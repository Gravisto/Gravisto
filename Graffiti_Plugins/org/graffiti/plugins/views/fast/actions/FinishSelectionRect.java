// =============================================================================
//
//   FinishRectSelectionAction.java
//
 ...
 */
@ActionId("finishSelectionRect")
public class FinishSelectionRect extends FastViewAction {
    @InSlot
    ...
    public void perform(InSlotMap in, OutSlotMap out, Graph graph,
        ...
        rect.add(position);
        view.getGestureFeedbackProvider().setSelectionRectangle(null);
