...
import org.graffiti.plugin.view.interactive.MousePressGesture;
 ...
 */
public class ExtendedMousePress extends MousePressGesture {
    private static MouseGestureFactory factory = new MouseGestureFactory() {
        ...
        public MouseGesture createGesture(Point2D position,
            ...
            return new ExtendedMousePress(position, event.getPoint(), event
    ...
    public ExtendedMousePress(Point2D position, Point2D rawPosition,
    ...
    public String toString() {
        return "ExtendedMousePress[position: " + getPosition().toString()
