...
public final class ToricalFastViewFamily extends ViewFamily<FastView> {
    /**
     ...
     * @see FastViewAction
     */
    protected ToricalFastViewFamily() {
        ...
        StartEdgeCreationOnTorus startEdgeCreation = new StartEdgeCreationOnTorus();
        add(startEdgeCreation);
        add(new SetLastEdgePoint(startEdgeCreation));
        add(new AddEdgePoint(startEdgeCreation));
        add(new FinishEdgeCreationOnTorus(startEdgeCreation));
        ...
        add(new RemoveBends());
        add(new AlignNodes());
        add(new CreateSnappedNodeOnTorus());
