...
/**
 * 
 * This code was taken from M. Westerheide's implementation of the VF2 graph
 * isomorphism plugin.
 * 
 ...
 */
public class GravISOParameterDialog extends AbstractParameterDialog implements
        ActionListener {
     ...
     */
    protected AbstractRefinementAlgorithm algorithmType;
     ...
     *            opened
     */
    public GravISOParameterDialog(EditComponentManager compManager,
            MainFrame parent, Parameter<?>[] params, Selection sel,
            String algoName, AbstractRefinementAlgorithm algo) {
        super(parent, true);
        ...
        // TODO: Text in properties einfügen
    ...
    public void setOkEnabled(Boolean b) {
        // Abfrage, ob die richtige Anzahl Graphen gew�hlt, k�nnte man auch
        // in
        // algorithm.check() machen wenn gew�nscht: das hier weglassen und
