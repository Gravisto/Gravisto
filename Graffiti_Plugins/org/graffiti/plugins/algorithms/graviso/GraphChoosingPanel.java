...
/**
 * This code was taken from M. Westerheide's implementation of the VF2
 * isomorphism plugin.
 * 
...
public class GraphChoosingPanel extends JPanel implements ActionListener {
    ...
    private GravISOParameterDialog parent;

    private AbstractRefinementAlgorithm algorithmType;
     ...
     *            opened.
     */
    public GraphChoosingPanel(GravISOParameterDialog parent,
            AbstractRefinementAlgorithm algo) {
