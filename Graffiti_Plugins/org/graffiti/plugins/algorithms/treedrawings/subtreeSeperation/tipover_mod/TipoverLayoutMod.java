 ...
 *          $
 */
public class TipoverLayoutMod extends AbstractAlgorithm {
    ...
    public String getName() {
        return "TipoverLayout Algorithm Mod";
    }
    ...
    public void setAlgorithmParameters(Parameter<?>[] params) {
        ...
        if (selectedNodePolicyName.equals("NONE_TAKE_ALL")) {
            this.selectedNodePolicy = TipoverLayoutMod.NONE_TAKE_ALL;
        } else if (selectedNodePolicyName.equals("ONLY_LOCAL")) {
            this.selectedNodePolicy = TipoverLayoutMod.ONLY_LOCAL;
        } else if (selectedNodePolicyName.equals("DOWNWARDS")) {
            this.selectedNodePolicy = TipoverLayoutMod.DOWNWARDS;
        }
    ...
    public void check() throws PreconditionException {
        ...
        try {
            ...
            if (this.selectedNodePolicy == TipoverLayoutMod.DOWNWARDS
                    || this.selectedNodePolicy == TipoverLayoutMod.ONLY_LOCAL) {
                ...
                if (this.selectedNodePolicy == TipoverLayoutMod.ONLY_LOCAL) {
    ...
    public void execute() {
        ...
        TipoverCompositionMod compositionFactory = new TipoverCompositionMod();
        ...
        if (this.selectedNodePolicy == TipoverLayoutMod.NONE_TAKE_ALL) {
            atoms = atomFinder.findAtoms(this.root);
        } else if (this.selectedNodePolicy == TipoverLayoutMod.DOWNWARDS) {
            atoms = atomFinder.findAtoms(this.selectedNode);
        } else if (this.selectedNodePolicy == TipoverLayoutMod.ONLY_LOCAL) {
