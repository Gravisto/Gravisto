...
package org.graffiti.plugins.algorithms.treedrawings.subtreeSeperation.tipover_mod;
 ...
 *          $
 */
public class TipoverCompositionMod extends TipoverComposition {
     ...
     *            children.
     */
    protected TipoverCompositionMod(Node root, double rootWidth,
        ...
        if (childCompositions == null || childCompositions.size() == 0) {
            ...
            if (this.horizontal) {
                ...
                double currentRelYpos = 0.0;
                if (!Util.isHelperNode(this.root)) {
                    currentRelYpos = this.rootHeight + nodeDistance;
                }
    ...
    public LayoutComposition instance(Node root,
        ...
        return new TipoverCompositionMod(root, rootWidth, rootHeight,
    ...
    public List<LayoutComposition> instance(Node root,
        ...
        resultList.add(new TipoverCompositionMod(root, rootWidth, rootHeight,
    ...
    protected void combine(Point2D rootCompositionTotalPosition,
        ...
        } else if (childComposition instanceof TipoverCompositionMod) {
            this.combineHelper(rootCompositionTotalPosition, childComposition,
                    childCompositionTotalPosition);
        } else
    ...
    protected void setLayoutAttributesLocal(double orderNumber) {
        ...
        StringAttribute layoutTypeAttribute = new StringAttribute("type", "m1");
