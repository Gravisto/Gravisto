...
//
// =============================================================================
// $Id: TipoverLayout.java 1728 2007-01-14 21:40:35Z keilhaue $
...
import org.graffiti.plugins.algorithms.treedrawings.subtreeSeperation.AtomFinderTipoverWithOrder;
 ...
 * 
 * @author Andreas
 * @version $Revision: 1728 $ $Date: 2007-01-14 22:40:35 +0100 (So, 14 Jan 2007)
 *          $
 */
public class TipoverLayoutMod2 extends AbstractAlgorithm {

    private LayoutComposition currentComposition = null;
    ...
    public String getName() {
        return "TipoverLayout Algorithm Mod2";
    }
    ...
    public void setAlgorithmParameters(Parameter<?>[] params) {
        ...
        if (selectedNodePolicyName.equals("NONE_TAKE_ALL")) {
            this.selectedNodePolicy = TipoverLayoutMod2.NONE_TAKE_ALL;
        } else if (selectedNodePolicyName.equals("ONLY_LOCAL")) {
            this.selectedNodePolicy = TipoverLayoutMod2.ONLY_LOCAL;
        } else if (selectedNodePolicyName.equals("DOWNWARDS")) {
            this.selectedNodePolicy = TipoverLayoutMod2.DOWNWARDS;
        }
    ...
    public void check() throws PreconditionException {
        ...
        try {
            ...
            if (this.selectedNodePolicy == TipoverLayoutMod2.DOWNWARDS
                    || this.selectedNodePolicy == TipoverLayoutMod2.ONLY_LOCAL) {
                ...
                if (this.selectedNodePolicy == TipoverLayoutMod2.ONLY_LOCAL) {
    ...
    public void execute() {
        ...
        TipoverCompositionMod2 compositionFactory = new TipoverCompositionMod2();

        AtomFinderTipoverWithOrder atomFinder = new AtomFinderTipoverWithOrder(
        ...
        if (this.selectedNodePolicy == TipoverLayoutMod2.NONE_TAKE_ALL) {
            atoms = atomFinder.findAtoms(this.root);
        } else if (this.selectedNodePolicy == TipoverLayoutMod2.DOWNWARDS) {
            atoms = atomFinder.findAtoms(this.selectedNode);
        } else if (this.selectedNodePolicy == TipoverLayoutMod2.ONLY_LOCAL) {
        ...
        if (bestFound != null) {
            ...
            // TODO: reset orderNumber after the following... Especially
            // important for DOWNWARDS and also for ONLY_LOCAL
            ...
            try {
                this.currentComposition = this.layoutRefresher
                        .reconstructComposition(this.root);
                this.currentComposition.layout(new Point2D.Double(0, 0));
            } catch (PreconditionException p) {
                ...
                try {
                    ...
                    this.currentComposition.layout(ca.getCoordinate());
    ...
    public LayoutComposition getCurrentComposition() {
