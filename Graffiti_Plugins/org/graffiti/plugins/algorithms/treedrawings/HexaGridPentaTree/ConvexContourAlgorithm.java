 ...
 */
public class ConvexContourAlgorithm extends AbstractAlgorithm {
    /**
     * Constructs a new instance.
     */
    public ConvexContourAlgorithm() {
    ...
    public String getName() {
        return "Convex Contours Algorithm";
    }
    ...
    public void execute() {
        ...
        pentaTree.calculateCompactedCoordinatesConvexContours();
        pentaTree.copyFinalCoordinatesToOriginalNodes();
