...
public class Grid {
     ...
     * @param length
     */
    public Grid(int length, FRGraphLabeling labeling) {
        ...
        initGrid(gridLength, labeling, gridSquares);
    }
     ...
     */
    private void initGrid(int gridLength, FRGraphLabeling labeling,
            HashMap<Point, GridSquare> gridSquares) {

        // save every node in the grid square it has to be assigned to
        for (FRNode node : labeling.getFRNodes()) {
            // node position
