...
public class FRSpringLabelingAlgorithmSomeParams extends
     ...
     * 
     */
    public FRSpringLabelingAlgorithmSomeParams() {
        super();
    ...
    public String getName() {
        return "Spring Embedder (some parameters adjustable)";
    }
    ...
    public Parameter<?>[] getAlgorithmParameters() {
        ...
        return new Parameter[] { selParam, this.viewAlgoritmStepsParam,
                this.nrQuenchingParam, startQuenchingTempParam,
                endQuenchingTempParam, this.nrSimmeringParam,
                startSimmeringTempParam, endSimmeringTempParam, localTempParam,
                variantsParam, isQuenchingPhaseParam, magnVariantsParam,
    ...
    public void setAlgorithmParameters(Parameter<?>[] params) {
        ...
        p.isLocalTemperature = ((BooleanParameter) params[8]).getBoolean()
                .booleanValue();

        auswahl = (StringSelectionParameter) params[9];

        p.isQuenchingPhase = ((BooleanParameter) params[10]).getBoolean()
                .booleanValue();
        ...
        p.magneticFieldParameter = (StringSelectionParameter) params[11];
        ...
        p.magneticSpringConstant = ((DoubleParameter) params[12]).getDouble();

        // Labeling params
        final int paramNr = 12;
        p.attractionConstantToLabel = ((DoubleParameter) params[paramNr + 1])
                .getDouble().doubleValue();
        p.repulsionConstantNodeToLabel = ((DoubleParameter) params[paramNr + 2])
                .getDouble().doubleValue();
        p.repulsionConstantBothLabels = ((DoubleParameter) params[paramNr + 3])
                .getDouble().doubleValue();
        p.optimalNodeDistanceToLabel = ((DoubleParameter) params[paramNr + 4])
                .getDouble().doubleValue();
        p.isEdgeLabelNodeRepulsionForce = ((BooleanParameter) params[paramNr + 5])
                .getBoolean().booleanValue();
        p.edgeLabelForceRepulsionMax = ((DoubleParameter) params[paramNr + 6])
                .getDouble().doubleValue();
        p.edgeLabelForceSoftOuterBorder = ((DoubleParameter) params[paramNr + 7])
                .getDouble().doubleValue();
        p.edgeLabelForceSoftInnerBorder = ((DoubleParameter) params[paramNr + 8])
                .getDouble().doubleValue();
        p.isLabelNodeEdgeRepulsion = ((BooleanParameter) params[paramNr + 9])
                .getBoolean().booleanValue();
        p.repulsionConstantLabelNodeEdge = ((DoubleParameter) params[paramNr + 10])
                .getDouble().doubleValue();
        p.isNodeLabelAdjacentEdgesRepulsion = ((BooleanParameter) params[paramNr + 11])
                .getBoolean().booleanValue();
        p.NodeLabelAdjacentEdgesRepulsionMaxForce = ((DoubleParameter) params[paramNr + 12])
                .getDouble().doubleValue();
        p.NodeLabelAdjacentEdgesRepulsionForceSoftInnerBorder = ((DoubleParameter) params[paramNr + 13])
                .getDouble().doubleValue();
